...
namespace Assignment1_PRN222_Group7_BLL.Services
{
    ...
    {
        /// <summary>Upsert a document chunk with embedding into vector DB. Returns embedding ID or null on failure.</summary>
        Task<string?> UpsertAsync(string collectionName, string id, float[] embedding, string text, Dictionary<string, string>? metadata = null);
